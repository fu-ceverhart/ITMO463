...
cd /home/ubuntu/coursera-cloud-computing/itmo-463-563/M5L8
# Pull latest changes
#sudo -u ubuntu git pull

sudo cp /home/ubuntu/coursera-cloud-computing/itmo-463-563/M5L8/default /etc/nginx/sites-available/default
