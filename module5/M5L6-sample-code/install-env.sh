...
cd /home/ubuntu/coursera-cloud-computing/itmo-463-563/M5L6
# Pull latest changes
#sudo -u ubuntu git pull

sudo cp /home/ubuntu/coursera-cloud-computing/itmo-463-563/M5L6/default /etc/nginx/sites-available/default
